...
/**
 * Displays a Braille-dot spinner on the current line while a blocking operation
 * runs.
 *
 * <p>
 * No-ops silently when the terminal is non-interactive (piped, redirected) so
 * machine
 * consumers see clean output. Must be closed (try-with-resources) to clear the
 * spinner line.
 */
